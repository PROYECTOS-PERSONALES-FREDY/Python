...
milabel.place(x=350, y=230)
milabel.config(font=15, bg="Black",fg='White')

image=Image.open("base.png")
image=image.resize((110,110), Image.ANTIALIAS)
img=ImageTk.PhotoImage(image)
lbl_img=Label(VentanaMenu, image=img)
lbl_img.pack()
lbl_img.place(x=100,y=410)

image=Image.open("reloj.png")
image=image.resize((110,110), Image.ANTIALIAS)
img1=ImageTk.PhotoImage(image)
lbl_img1=Label(VentanaMenu, image=img1)
lbl_img1.pack()
lbl_img1.place(x=210,y=410)

image=Image.open("virus.png")
image=image.resize((110,110), Image.ANTIALIAS)
img2=ImageTk.PhotoImage(image)
lbl_img2=Label(VentanaMenu, image=img2)
lbl_img2.pack()
lbl_img2.place(x=610,y=410)

image=Image.open("luz.png")
image=image.resize((110,110), Image.ANTIALIAS)
img3=ImageTk.PhotoImage(image)
lbl_img3=Label(VentanaMenu, image=img3)
lbl_img3.pack()
lbl_img3.place(x=500,y=410)

image=Image.open("viirus.png")
image=image.resize((150,150), Image.ANTIALIAS)
img4=ImageTk.PhotoImage(image)
lbl_img4=Label(VentanaMenu, image=img4)
lbl_img4.pack()
lbl_img4.place(x=570,y=50)

image=Image.open("luz2.png")
image=image.resize((150,150), Image.ANTIALIAS)
img5=ImageTk.PhotoImage(image)
lbl_img5=Label(VentanaMenu, image=img5)
lbl_img5.pack()
lbl_img5.place(x=100,y=50)
...
def base():
     ...
     ## print(vector[i][0])#Tiempo Insertado un numero
      if(i==0):
        numeros[0]=str(vector[i][0])
      elif(i==1):
        numeros[1]=str(vector[i][1])
      elif(i==2):
        numeros[2]=str(vector[i][2])
      elif(i==3):
        numeros[3]=str(vector[i][3])
      elif(i==4):
        numeros[4]=str(vector[i][4])
      elif(i==5):
        numeros[5]=str(vector[i][5])
      elif(i==6):
        numeros[6]=str(vector[i][6])
      elif(i==7):
        numeros[7]=str(vector[i][7])
      elif(i==8):
        numeros[8]=str(vector[i][8])
      elif(i==9):
        numeros[9]=str(vector[i][9])
      else:
...
def Vm():
    ...
    def desin():
     ...
     for t in range (1,tem+1):
        xxx= StringVar()
        xxx=Label(VentanaMotores)
        xxx.place(x=360, y=520)
        xxx.config(font=10,bg="Black",fg='White',text=tem-t)
        print(tem-t)
        time.sleep(1) 
     ...
     labeldesin.place(x=350, y=200)
     labeldesin.config(font=10,bg="Black",fg='White')

  

     labeldesin4=Label(Ventanadesin)
     labeldesin4.config(text="Espere ")
     labeldesin4.place(x=400, y=240)
     labeldesin4.config(font=10,bg="Black",fg='White')

     labeldesin3=Label(Ventanadesin)
     labeldesin3.config(text=Grado)
     labeldesin3.place(x=420, y=270)
     labeldesin3.config(font=10,bg="Black",fg='White')

     labeldesin4=Label(Ventanadesin)
     labeldesin4.config(text="Minutos")
     labeldesin4.place(x=400, y=300)
     labeldesin4.config(font=10,bg="Black",fg='White')
